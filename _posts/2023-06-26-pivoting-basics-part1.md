...
What the f*** is pivoting? In short, it occurs when you have a foothold onto a compromised machine, and wish to access a network that is otherwise not publically facing. For an example, let's consider the following. If you have a web server, call it WEB01, with a public IP of 10.10.110.10, of which you have compromised and have access to, and wish to pivot to an internal network, 172.18.1.0/24, pivoting on the WEB01 box would provide you access to 172.18.1.0/24 to your Kali Linux machine. For the following scenario, and for the rest of my walkthroughs, the following will remain true:
